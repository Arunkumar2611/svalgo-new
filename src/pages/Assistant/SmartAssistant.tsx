                        ...
                        <Box sx={{ display: 'flex', alignItems: 'center' }}>
                            ...
                            <Box>
                                ...
                                <Typography variant="caption" color="text.secondary">
                                    Powered by Nexus AI to optimize your collection strategies using machine learning and behavioral analysis
                                </Typography>
                            </Box>
                        </Box>
                        <IconButton>
                    ...
                    {innerTabValue === 2 && ( // Chat Assistant
                        <Box sx={{ p: 2.5, display: 'flex', flexDirection: 'column', height: '400px' /* Adjust height as needed */ }}>
                            ...
                            <Box sx={{ display: 'flex', alignItems: 'center', borderTop: 1, borderColor: 'divider', pt: 2 }}>
                                ...
                                />
                                <IconButton sx={{ color: '#5D3FD3', bgcolor: '#5D3FD3', borderRadius: '8px', '&:hover': { bgcolor: '#4B2F9D', color: 'white' } }}>
                                    <SendIcon />
                                </IconButton>
                            </Box>
                        </Box>
